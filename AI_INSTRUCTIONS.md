...
11. **Запрещено** использовать `if ... endif`, `box 0 0 800 600`, `item x y w h` без скобок
---
...
## Версия
2.0 — март 2026 (обновлено: добавлены расширенные правила синтаксиса item, форматы вывода, условные конструкции, примеры из реальных проектов)
